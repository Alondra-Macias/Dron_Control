...
#define I2C_MULT_1 0x00
#define I2C_MULT_2 0x40
#define I2C_MULT_4 0x80

#define I2C_SCL_26 0x03
...
BooleanType I2C_busy(void);
 ...
 /*!
  	 \brief
  	 	 It generates the ACKnowledge that is needed when the master reads data.
  	 \return void
